...
function toggleLoading(isLoading) {
  ...
  if (isLoading) {
    ...
    submitBtn.classList.remove("fa-search");
    submitBtn.classList.add("fa-hourglass-half");
  } else {
    submitBtn.textContent = "Search";
    submitBtn.disabled = false;
    submitBtn.classList.remove("fa-hourglass-half");
    submitBtn.classList.add("fa-search");
  }
}
